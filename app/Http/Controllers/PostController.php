...
class PostController extends Controller
{
    ...
    protected function requestValidate($request)
    {
        ...
        // ]);
        return $request->validate([
            'job_title' => 'required|min:3|regex:/^[A-Za-z\s]+$/',
            'job_level' => 'required',
            'vacancy_count' => 'required|int|max:100',
            'employment_type' => 'required',
            'job_location' => 'required',
            ...
            'job_title.regex' => 'The job title should contain only alphabets.',
            'deadline.after_or_equal' => 'The deadline should be on or after the current date.',
        ]);
    }
}

...
<body>
    <div class="container p-0 shadow-lg h-full my-4" id="parent">
        <div class="d-flex">
                ...
                @if(isset($user_detail))
                    @if($image == 'yes' && $user_detail->picture != NULL)
                        <div class="pt-2 text-center">
                            ...
                            <span><img class="rounded-circle" src="http://localhost/fyp%20implementaion/public/storage/images/{{ $user_detail->picture }}" alt="" height="130" width="130"></span>
                        </div>
                        {{-- <div class="pt-2 text-center">

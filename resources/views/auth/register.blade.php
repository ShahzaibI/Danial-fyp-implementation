                ...
                <div class="login-form">
                    <form action="{{route('register')}}" method="POST" onsubmit="return registrationValidation()">
                        ...
                        <div class="form-group">
                            ...
                            <input id="name" type="name" placeholder="Full name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="name" autofocus required><br>
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" type="email" placeholder="E-mail address" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" autocomplete="email" autofocus required>
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
